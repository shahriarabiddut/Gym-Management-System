...
class SupportController extends Controller
{
    ...
    //     //header And Sidebar
    //     return view('user.support.edit',['data' => $data,'dataMessage'=>$dataMessage,'sorryRoomSidebar'=>$sorryRoomSidebar]);
    // }
    ...
    //     return redirect('user/support')->with('success','Support Ticket has been Updated Successfully!');
    // }
